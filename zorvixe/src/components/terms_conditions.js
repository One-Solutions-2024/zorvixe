                        ...
                        <div className="row card p-4">
                            <div className="col-lg-12 col-12">
                                ...
                                <div className="text-center mb-5">
                                    <h1 className="display-5 fw-bold text-primary">Terms and Conditions</h1>
                                </div>

                                <div className="section-heading mb-5">
                                    <p className="fs-5">Please read these terms and conditions carefully before using Our Service.</p>

                                    <h4 className="mt-5 pt-3 fw-bold text-dark">Interpretation and Definitions</h4>

                                    <h5 className="mt-4 fw-semibold text-secondary">Interpretation</h5>
                                    ...
                                    <h5 className="mt-4 fw-semibold text-secondary">Definitions</h5>
                                    <p>For the purposes of these Terms and Conditions:</p>
                                    <ul className="list-unstyled">
                                        <li className="mb-3">
                                            <p><strong className="text-dark">Affiliate</strong> means an entity that controls, is controlled by or is
                                        ...
                                        <li className="mb-3">
                                            <p><strong className="text-dark">Country</strong> refers to: Karnataka, India</p>
                                        </li>
                                        <li className="mb-3">
                                        ...
                                        <li className="mb-3">
                                            <p><strong className="text-dark">Service</strong> refers to the Website.</p>
                                        </li>
                                        <li className="mb-3">
                                            <p><strong className="text-dark">Terms and Conditions</strong> (also referred as &quot;Terms&quot;) mean these
                                                Terms and Conditions that form the entire agreement between You and the Company
                                                regarding the use of the Service. </p>
                                        </li>
                                        <li className="mb-3">
                                            <p><strong className="text-dark">Third-party Social Media Service</strong> means any services or content
                                    ...
                                    <h4 className="mt-5 pt-3 fw-bold text-dark">Acknowledgment</h4>
                                    ...
                                    <h4 className="mt-5 pt-3 fw-bold text-dark">Links to Other Websites</h4>
                                    ...
                                    <h4 className="mt-5 pt-3 fw-bold text-dark">Termination</h4>
                                    ...
                                    <h4 className="mt-5 pt-3 fw-bold text-dark">Limitation of Liability</h4>
                                    ...
                                    <h4 className="mt-5 pt-3 fw-bold text-dark">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h4>
                                    ...
                                    <h4 className="mt-5 pt-3 fw-bold text-dark">Governing Law</h4>
                                    ...
                                    <h4 className="mt-5 pt-3 fw-bold text-dark">Disputes Resolution</h4>
                                    ...
                                    <h4 className="mt-5 pt-3 fw-bold text-dark">For European Union (EU) Users</h4>
                                    ...
                                    <h4 className="mt-5 pt-3 fw-bold text-dark">United States Legal Compliance</h4>
                                    ...
                                    <h4 className="mt-5 pt-3 fw-bold text-dark">Severability and Waiver</h4>
                                    <h5 className="mt-3 fw-semibold text-secondary">Severability</h5>
                                    ...
                                    <h5 className="mt-3 fw-semibold text-secondary">Waiver</h5>
                                    ...
                                    <h4 className="mt-5 pt-3 fw-bold text-dark">Translation Interpretation</h4>
                                    <p>These Terms and Conditions may have been translated if We have made them available to You on
                                        our Service.
                                        You agree that the original English text shall prevail in the case of a dispute.</p>

                                    <h4 className="mt-5 pt-3 fw-bold text-dark">Changes to These Terms and Conditions</h4>
                                    ...
                                    <h4 className="mt-5 pt-3 fw-bold text-dark">Contact Us</h4>
