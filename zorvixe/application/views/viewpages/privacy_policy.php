                ...
                <div class="col-lg-12 col-12">
                    <div class="section-heading mb-5">
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>Website</strong> refers to Zorvixe, accessible from <a
                                        href="https://Zorvixe.com/" rel="external nofollow noopener"
                                        target="_blank">https://Zorvixe.com/</a></p>
                            </li>
                            <li>
                        ...
                        <p>When you contact us via email or fill out a form on our site, we collect and store your
                            information to respond to your inquiry.</p>
                        ...
                        <ul>
                            ...
                            <li>
                                <p>Fill out a form on our site</p>
                            </li>
                        </ul>
                        ...
                        <p>If you submit your personal information and contact details, we reserve the right to contact
                            you via:</p>
                        <ul>
                            <li>
                                <p>Phone call</p>
                        ...
                        <ul>
                            <li>By email: <a href="mailto:info@Zorvixe.com">&nbsp;&nbsp;info@Zorvixe.com</a>
                            </li>
                        </ul>
                        </p>
                    </div>
